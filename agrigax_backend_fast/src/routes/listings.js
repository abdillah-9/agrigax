...
listingsRouter.post("/", ...guards.provider, validate(schemas.create), asyncHandler(createListing));
listingsRouter.put("/:id", ...guards.provider, validate(schemas.update), asyncHandler(updateListing));
