  ...
  return (
    <main className="p-xl">
      ...
      <section className="service-form-card shadow-md radius-lg">
        <div className="mb-xl">
          <h1 className="text-2xl fw-bold neutral-dark">Create Listing</h1>
          <p className="text-sm mt-sm">Add a new listing to your profile</p>
        </div>

        <form className="service-form" onSubmit={handleSubmit}>
          <div className="service-field">
            <label className="label label-required">Listing Title</label>
            <input className="input-text" type="text" placeholder="e.g. Tractor Rental" value={form.title} onChange={e => handleChange("title", e.target.value)} required />
          </div>
          ...
          <div className="service-field">
            ...
            <input className="input-text" type="number" placeholder="Enter price" value={form.price} onChange={e => handleChange("price", e.target.value)} required />
          </div>

          <div className="service-field">
            <label className="label label-required">Location</label>
            <input className="input-text" type="text" placeholder="e.g. Dar es Salaam" value={form.location} onChange={e => handleChange("location", e.target.value)} />
          </div>

          <div className="service-field">
            <label className="label label-required">Description</label>
            <textarea className="input-textarea" placeholder="Describe your listing..." value={form.description} onChange={e => handleChange("description", e.target.value)} />
          </div>
